...
//					System.out.println("row found");
	...
	public void setDimensions(int[] dimensions)
	{
		...
		if(dimensions[1] == DEFAULT)
			dimensions[1] = matrixHeight; // increase rows by one; "height" increased by one
		else if(dimensions[1] == PLUSONE)
			dimensions[1] = matrixHeight + 1; // increase columns by one; simply add a cell to each row
