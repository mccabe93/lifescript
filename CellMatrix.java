...
public class CellMatrix {
	...
	*/	
	...
	public String[] getColors() {
		return Matrix[current].color;
	}

	public void setColor(String hex) {
		Matrix[current].color = hex;
	}

	public class CellNode {
		public boolean	changed = false; // whether this cell changed this generation
		public int state = 0;
		public String type, color = "0xffffff"; 
...
//					System.out.println("row found");
	...
	public void setDimensions(int[] dimensions)
	{
		...
		else if(dimensions[1] == DEFAULT)
			dimensions[1] = Matrix.length/matrixWidth;

		if(dimensions[0] == PLUSONE)
			dimensions[1] += 1;		// increase rows by one; "height" increased by one
