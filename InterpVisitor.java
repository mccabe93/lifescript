...
public class InterpVisitor {
	...
	{
		System.out.println("setting interval: " + this.dispatch(ast.getAST(0)));
		return null;
	}

	private Double interp(PausableStmt ast)
	{
		System.out.println("setting pausable: " + this.dispatch(ast.getAST(0)));
		return null;
	}

	private Double interp(SteppableStmt ast)
	{
		System.out.println("setting steppable: " + this.dispatch(ast.getAST(0)));
		return null;
	}
